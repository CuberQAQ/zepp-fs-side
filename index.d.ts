 ...
 * ```
 */
export export function openSync(option: openSync.Option): openSync.Result;
 ...
 * ```
 */
export function openAssetsSync(option: openAssetsSync.Option): openAssetsSync.Result;
namespace statSync {
  interface Option {
    /**
     * @zh 路径
 ...
 * ```
 */
export function statSync(option: statSync.Option): statSync.Result;
 ...
 * ```
 */
export function statAssetsSync(option: statAssetsSync.Option): statAssetsSync.Result;
namespace closeSync {
  interface Option {
    /**
 ...
 * ```
 */
export function closeSync(option: closeSync.Option): closeSync.Result;
export function closeSync(fd: number): closeSync.Result;
namespace readSync {
  interface Option {
    /**
     * @zh 文件句柄，由 `openSync`、`openAssetsSync` 等 API 返回
 ...
 * ```
 */
export function readSync(option: readSync.Option): readSync.Result;
namespace writeSync {
  interface Option {
    /**
     * @zh 文件句柄，由 `openSync`、`openAssetsSync` 等 API 返回
 ...
 * ```
 */
export function writeSync(option: writeSync.Option): writeSync.Result;
namespace rmSync {
  interface Option {
    /**
     * @zh 文件路径
 ...
 * ```
 */
export function rmSync(option: rmSync.Option): rmSync.Result;
export function rmSync(path: string): rmSync.Result;
 ...
 * ```
 */
export function renameSync(option: renameSync.Option): renameSync.Result;
namespace mkdirSync {
  interface Option {
    /**
     * @zh 目录路径
 ...
 * ```
 */
export function mkdirSync(option: mkdirSync.Option): mkdirSync.Result;
export function mkdirSync(path: string): mkdirSync.Result;
 ...
 * ```
 */
export function readdirSync(option: readdirSync.Option): readdirSync.Result;
 ...
 * ```
 */
export function readFileSync(option: readFileSync.Option): readFileSync.Result;
 ...
 * ```
 */
export function writeFileSync(option: writeFileSync.Option): void;
